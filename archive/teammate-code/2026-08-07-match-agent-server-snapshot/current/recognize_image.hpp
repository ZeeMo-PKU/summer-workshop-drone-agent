...
// API key：优先读环境变量 DASHSCOPE_API_KEY；未设置时回退到此常量。
inline constexpr const char* kFallbackApiKey =
    "sk-ws-H.ELEEPPR.QjKt.MEYCIQC9gZIn1MIgiUpSYl5AAXTEzWVNrIFXIssCweI5RbzDWgIhAPZO-YSgBTRiZlVbRDGHYvVM6_zkTZVUsXuQd2XxMl5P";
